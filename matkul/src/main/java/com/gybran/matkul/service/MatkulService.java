 ...
 */
package com.gybran.matkul.service;

import com.gybran.matkul.entity.Matkul;
import com.gybran.matkul.repository.MatkulRepository;
...
public class MatkulService {
    ...
    public Matkul getMatkul(Long id) {
        Optional<Matkul> matkulOptional = matkulrepository.findById(id);
